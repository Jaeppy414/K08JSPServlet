...
public class BoardDAO extends JDBConnect {
	...
	public List<BoardDTO> selectList(Map<String, Object> map){
		...
		//List계열의 컬렉션을 생성 이때 타입 매개변수는 
		//BoardDTO객체로 설정한다.
		//굳이 왜 List를 쓰느냐? -> 게시판 목록은 출력순서가 보장되야 하므로 Set컬렉션은
...
//		select num, title, name, visitcount, postdate from board inner join member using(id) where num=1;
