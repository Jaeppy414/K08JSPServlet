...
<body>
	...
	<!-- 해당 변수를 통해 확장for문을 실행한다. items에 지정한 컬렉션에
	...
	<h4>Map 컬렉션 사용하기</h4>
	<%
	//Map계열의 컬렉션을 생성한다. Key는 String, Value는 Person타입으로 지정한다.
	...
	for(String key : keys){
		//key를 통해 Value를 얻어온다. 여기서 Value는 Person객체이므로
